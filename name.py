    ...
    default_data = pd.DataFrame(
        {
            "food": [
                "닭가슴살 구이",
                    ...
                    "채소 볶음 + 병아리콩 토핑",
                    "그릭 요거트 + 블루베리 + 아몬드",
                    "스무디 볼 (바나나, 시금치, 단백질 파우더)",
                    "계란말이 + 방울토마토 샐러드",
                    "렌틸콩 샐러드 + 시트러스 드레싱",
                    "통밀 또띠아 치킨 랩 (닭가슴살 + 아보카도)",
                    "터키 미트볼 + 구운 파프리카",
                    "현미 오트밀 (견과류 + 키위)",
                    "퀴노아 라이스 + 구운 가지",
                    "두부 샐러드 (두부, 적채, 무순)",
                    ...
                    "고등어 구이 + 현미밥 + 무순 샐러드",
                    "에어프라이어 고구마 + 두부 구이",
                    "치킨 샐러드 (닭가슴살, 셀러리, 요거트 드레싱)",
                    "렌틸콩 타코 볼 + 아보카도",
                    "버섯 퀴노아 리조또 (저지방 치즈 살짝)",
                    "병아리콩 스프 + 통곡물 크래커",
                    "두부 볶음 + 브뤼셀 스프라우트",
                    "훈제 연어 퀴노아 보울 (올리브 오일 드레싱)",
                    "닭고기 & 렌틸콩 카레 + 잡곡밥",
                    "두부 샌드위치 (통밀빵 + 채소 + 두부)",
                    "채소 샐러드 + 삶은 달걀 + 견과류",
                    "닭가슴살 구이 + 구운 고구마 + 볶은 시금치",
                    "퀴노아 프라이드 라이스 (채소 + 계란)",
                    "터키 버거 (통밀 번 + 샐러드)",
                    "병아리콩 파스타 샐러드 (통곡물 파스타)",
                    "스파이시 연어 볼 (연어 + 고추 + 아보카도)",
                    "렌틸콩 & 두부 볼 + 브로콜리 스팀",
                    "두유 오트밀 + 베리 믹스",
                    "현미 & 병아리콩 비빔밥 + 저염 간장",
                    "영양 채소죽 (브로콜리, 당근, 양배추)",
                    "닭가슴살 시저 샐러드 (드레싱은 요거트 기반)",
                    "퀴노아 + 고구마 + 시금치 볼",
                    "구운 야채 & 통밀 파니니 (두부 또는 치킨)",
                    "콩 샐러드 (검은콩, 옥수수, 토마토)",
                    "닭가슴살 스튜 + 통곡물 빵"
            ],
            "category": [
